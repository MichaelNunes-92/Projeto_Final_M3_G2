...
INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES  (1, "Mais que pronto" ,1);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 2, "Provou seu diferencial",10);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 3,  "Colocou tudo em prática",9);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 4, "Mais que pronto" ,10);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 5,  "Colocou tudo em prática",2);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 6,  "Provou seu diferencial",1);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 7, "Colocou tudo em prática" ,10);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 8,"Está quase lá"  ,6);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES( 9,"Colocou tudo em prática"  ,3);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES (10, "Mais que pronto" ,6);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 11, "Provou seu diferencial" ,5);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 12, "Chegando lá" ,6);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES  ( 13, "Está quase lá"  ,5);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES( 14, "Mais que pronto" ,2);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES  ( 15,"Mais que pronto"  ,2);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 16,"Mais que pronto" ,6);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES( 17,"Está quase lá"  ,6);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 18, "Provou seu diferencial" ,6);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 19,"Chegando lá"  ,2);
    INSERT INTO Avaliacao (ID_MATRICULA,avaliacao,ID_TURMA)
	VALUES ( 20, "Mais que pronto" ,6);
